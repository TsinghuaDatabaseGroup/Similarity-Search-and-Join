...
import hadoop.recordjoin.RecordJoinMap;
import hadoop.recordjoin.RecordJoinMapCandidate;
...
public class Verify {
	public static void main(String[] args) throws IOException {
		...
		job.setMapOutputValueClass(RecordJoinOutputValue.class);
		job.setReducerClass(VerifyReduce.class);
		job.setOutputKeyClass(Text.class);
		
		MultipleInputs.addInputPath(job, new Path(Config.INPUT_PATH + "/" + Config.RECORD2), KeyValueTextInputFormat.class, VerifyMap.class);
		MultipleInputs.addInputPath(job, new Path("middle"), SequenceFileInputFormat.class, VerifyMapCandidate.class);
