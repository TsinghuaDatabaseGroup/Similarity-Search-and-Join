...
public class JoinKernel {
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < Config.NUM_OF_BITSET; i++) {
			addCacheFiles(configuration, "bloomfilter/" + i);
		}
		...
		FileInputFormat.addInputPath(job, new Path("record1/"));
		FileInputFormat.addInputPath(job, new Path("record2/"));
